...
public class AES
{
    ...
    private static byte[] block, key, inicial;
    ...
    public static void encrypt()
    {
        ...
        //state -> 4 posiciones  --> 4 Bytes q son 8 bits -> se corresponden de inicial con: 0,4,8,12

        for(int i = 0; i < 4; ++i){
            Byte b1 = state[i].byte1;
            BitSet bb1 = BitSet.valueOf(new byte[]{b1});
            BitSet ini1 = BitSet.valueOf(new byte[]{inicial[i]});
            Byte b2 = state[i].byte2;
            BitSet bb2 = BitSet.valueOf(new byte[]{b2});
            BitSet ini2 = BitSet.valueOf(new byte[]{inicial[i+4]});
            Byte b3 = state[i].byte3;
            BitSet bb3 = BitSet.valueOf(new byte[]{b3});;
            BitSet ini3 = BitSet.valueOf(new byte[]{inicial[i+8]});
            Byte b4 = state[i].byte4;
            BitSet bb4 = BitSet.valueOf(new byte[]{b4});;
            BitSet ini4 = BitSet.valueOf(new byte[]{inicial[i+12]});
            for (int j = 0; j < 8; ++j){
                if (bb1.get(j) != ini1.get(j)) ++a[i*8+j];
                if (bb2.get(j) != ini2.get(j)) ++a[i*8+32+j];
                if (bb3.get(j) != ini3.get(j)) ++a[i*8+64+j];
                if (bb4.get(j) != ini4.get(j)) ++a[i*8+96+j];
            }
        }
       // System.out.printf("%02X %02X %02X %02X", w[0].byte1, w[1].byte1, w[2].byte1, w[3].byte1);
       // System.out.println("");
       // System.out.printf("%02X %02X %02X %02X", w[0].byte2, w[1].byte2, w[2].byte2, w[3].byte2);
        ...
        //inicial -> 16 posiciones -> 1 byte cada una
    ...
    public static void main(String[] args)
    {
      ...
      //  block = new byte[] {(byte) 0x15,(byte) 0x33,(byte) 0x7e, (byte) 0xb3,(byte) 0x97,(byte) 0x1c,(byte) 0x6d,(byte) 0xea,(byte) 0xc4, (byte) 0xc2, (byte) 0x1b,(byte) 0x3b,(byte) 0xef,(byte) 0x8b, (byte) 0x2e, (byte) 0x95};
      //  block = new byte[] {(byte) 0x15,(byte) 0x33,(byte) 0x7e, (byte) 0xb3,(byte) 0x97,(byte) 0x1c,(byte) 0x6d,(byte) 0xea,(byte) 0xc4, (byte) 0x82, (byte) 0x1b,(byte) 0x3b,(byte) 0xef,(byte) 0x8b, (byte) 0x2e, (byte) 0x95};
      //  block = new byte[] {(byte) 0x15,(byte) 0x33,(byte) 0x7e, (byte) 0x93,(byte) 0x97,(byte) 0x1c,(byte) 0x6d,(byte) 0xea,(byte) 0xc4, (byte) 0xc2, (byte) 0x1b,(byte) 0x3b,(byte) 0xef,(byte) 0x8b, (byte) 0x2e, (byte) 0x95};
      //  block = new byte[] {(byte) 0x15,(byte) 0x33,(byte) 0x7e, (byte) 0x93,(byte) 0x97,(byte) 0x1c,(byte) 0x6d,(byte) 0xea,(byte) 0xc4, (byte) 0x82, (byte) 0x1b,(byte) 0x3b,(byte) 0xef,(byte) 0x8b, (byte) 0x2e, (byte) 0x95};//  block = new byte[] {(byte) 0x15,(byte) 0x33,(byte) 0x7e, (byte) 0x93,(byte) 0x97,(byte) 0x1c,(byte) 0x6d,(byte) 0xea,(byte) 0xc4, (byte) 0x82, (byte) 0x1b,(byte) 0x3b,(byte) 0xef,(byte) 0x8b, (byte) 0x2e, (byte) 0x95};
      //s box 83 es 00, hay q forzar q eso quede al principio
        block = new byte[] {(byte) 0x35,(byte) 0x33,(byte) 0x7e, (byte) 0xb3,(byte) 0x97,(byte) 0x1c,(byte) 0x6d,(byte) 0xea,(byte) 0xc4, (byte) 0xc2, (byte) 0x1b,(byte) 0x3b,(byte) 0xef,(byte) 0x8b, (byte) 0x2e, (byte) 0x95};
        ...
        keyExpansion();
        inicial = new byte[] {(byte) 0x9B,(byte) 0x0A,(byte) 0x4E, (byte) 0x4F,(byte) 0xB9,(byte) 0xE7,(byte) 0xE5,(byte) 0x7E,(byte) 0x4E, (byte) 0xA2, (byte) 0xFE,(byte) 0xF5,(byte) 0x95,(byte) 0x7C, (byte) 0xE9, (byte) 0xA3};
